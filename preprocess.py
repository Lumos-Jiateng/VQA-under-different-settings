...
data_cfg = edict({
        ...
        'pre_val_file_mindrecord': './premindrecord/pre_val.mindrecord',
        'train_file_mindrecord': './mindrecord/train.mindrecord',
        'test_file_mindrecord': './mindrecord/test.mindrecord',
        'val_file_mindrecord': './mindrecord/val.mindrecord',
        'num_splits':4,
...
np.save('class_answer.npy', class_answer)
...
pre_train_data = load_pre_dataset(batch_size = 128, data_file=data_cfg.pre_train_file_mindrecord)
...
pre_test_data = load_pre_dataset(batch_size = 128, data_file=data_cfg.pre_test_file_mindrecord)
...
pre_val_data = load_pre_dataset(batch_size = 128, data_file=data_cfg.pre_val_file_mindrecord)
